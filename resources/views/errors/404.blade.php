...
{{ __('template.errorpage.404.title') }}
...
<div class="box">
	...
	<h1>{{ __('template.errorpage.404.header')}}</h1>

	<p>{{ __('template.errorpage.404.body') }}</p>

		<br/> <span class="label label-danger">Oh no the Invaders destroyed this page! Take revenge for our Crew!</span> Move with: <span class="label label-danger">←</span>&#160;<span class="label label-danger">→</span> &#160;&#160;&#160;<button class="btn btn-warning btn-xs" id="restart">Neustart</button></p>

		<canvas id="space-invaders"/>



		<a href="{{ route('news.index') }}">Back to Main page</a>
...
<script>
  ...
  invaderAsset.src = "{{ asset('img/invader.gif') }}";
