  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-default">
        You may also do:
<br>
        flash('Message')->success(): Set the flash theme to "success".<br>
        flash('Message')->error(): Set the flash theme to "danger".<br>
        flash('Message')->warning(): Set the flash theme to "warning".<br>
        flash('Message')->overlay(): Render the message as an overlay.<br>
        flash()->overlay('Modal Message', 'Modal Title'): Display a modal overlay with a title.<br>
        flash('Message')->important(): Add a close button to the flash message.<br>
        flash('Message')->error()->important(): Render a "danger" flash message that must be dismissed.<br>
      </div>
    </div>
  </div>
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <script>
        ...
        $( document ).ready(function() {
          ...
          var tag =  document.getElementById("uielements");
          tag.className += " active";
        });
      </script>
