<a class="fas fa-exclamation-triangle header-user-button" data-toggle="modal" data-target="#issueModal" style="cursor: pointer;"><span ></span></a>
		...
		{{ csrf_field() }}
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="submit" class="btn btn-xs btn-success"><span class="far fa-save"></span></button>
				</div>
			</div>
